...
public class QuestLog extends Logger {
 public static Properties properties;
 static private RepositorySelector myRepositorySelector;
 
 protected QuestLog(String name) {
  super(name);
 ...
 static {
	  if (properties == null) {
		   ...
		   try {
			...
			if (res!=null)
				path = res.getPath();	    
		    String filePath = path + "quest.properties" ;
   ...
   public static Logger getLogger(String name)
    ...
    public static void main(String[] args){
    	QuestLog.getRootLogger().info("ccc");
    	SigninLog.getRootLogger().info("ddd");
    }
} 